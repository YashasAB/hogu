...
router.get("/tables", requireAdminAuth, async (_req: Request, res: Response) => {
  try {
...
router.get("/tables/:table", requireAdminAuth, async (req: Request, res: Response) => {
  try {
...
router.get("/tables/:table/:id", requireAdminAuth, async (req: Request, res: Response) => {
  try {
...
router.put("/tables/:table/:id", requireAdminAuth, async (req: Request, res: Response) => {
  try {
    const { table, id } = req.params;
    const data = req.body;
...
router.post("/tables/:table", requireAdminAuth, async (req: Request, res: Response) => {
  try {
    const { table } = req.params;
    const data = req.body;
...
router.delete("/tables/:table/:id", requireAdminAuth, async (req: Request, res: Response) => {
  try {
    const { table, id } = req.params;
