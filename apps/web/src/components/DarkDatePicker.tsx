  ...
  return (
    <div className="w-full">
      ...
      <button
        ...
        className="h-12 w-full rounded-xl bg-slate-800 border border-white/10 px-3 text-left text-sm text-slate-200 focus:outline-none focus:ring-2 focus:ring-rose-500/30 flex items-center justify-between"
      >
        {selected ? (
