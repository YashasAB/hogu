...
const restaurants: Restaurant[] = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1528605105345-5344ea20e269?q=80&w=1600&auto=format&fit=crop",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1542326237-94b1c5a538d8?q=80&w=1600&auto=format&fit=crop",
    neighborhood: "UB City",
    category: "cocktails",
    hot: true,
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1541745537413-b804d1a57a51?q=80&w=1600&auto=format&fit=crop",
...
const Row: React.FC<{ label: string; last?: boolean; children: React.ReactNode }> = ({ label, last, children }) => (
  <div className={`flex items-center justify-between py-3 ${last ? '' : 'border-b border-white/10'}`}>
    ...
    return (
      <div className="min-h-dvh bg-slate-950 text-slate-100 flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-slate-400">The restaurant you're looking for doesn't exist.</p>
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-6 lg:py-10">
            ...
            <div className="flex items-end justify-between gap-3 md:gap-4">
              <div>
                <div className="flex items-center gap-2 md:gap-3 mb-2">
                  <span className="text-2xl drop-shadow">{restaurant.emoji}</span>
              ...
              <div className="hidden sm:flex gap-2">
                {restaurant.instagramUrl && (
                  ...
                  >
                    <span className="inline-flex items-center gap-1"><span aria-hidden>📸</span><span>Instagram</span></span>
                  </a>
                )}
                {restaurant.website && (
                  <a 
        ...
        <div className="mt-6 sm:mt-8 grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            <section className="rounded-2xl p-4 sm:p-5 ring-1 ring-white/10 bg-slate-900/70">
              <h2 className="text-lg sm:text-xl font-semibold mb-3">Coordinates</h2>
              <div className="text-sm opacity-80">{restaurant.position.lat.toFixed(6)}, {restaurant.position.lng.toFixed(6)}</div>
            </section>
          </div>
          ...
          <aside className="lg:col-span-1" ref={bookingRef}>
            <div className="rounded-2xl p-4 sm:p-5 ring-1 ring-white/10 bg-slate-900/80 shadow-xl lg:sticky lg:top-20">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-base sm:text-lg font-semibold">Make a reservation</h2>
              </div>
                ...
                {timeSlots.map((slot) => {
                  ...
                  return (
                    <button
                      ...
                      className={[
                        base,
                        selected && "bg-gradient-to-r from-rose-600 to-amber-500 text-slate-900 border-transparent",
                        !selected && slot.available && "bg-slate-800 border-white/10 hover:border-rose-500/30",
                        !slot.available && "bg-slate-800/40 border-white/5 text-slate-500 cursor-not-allowed",
                      ].filter(Boolean).join(' ')}
                    >
                      {slot.time}
                    </button>
              ...
              <div className="hidden md:block">
                ...
                <p className="mt-3 text-xs opacity-70">
                  You won't be charged yet. Confirmation depends on restaurant availability.
                </p>
              </div>
            </div>
          </aside>
