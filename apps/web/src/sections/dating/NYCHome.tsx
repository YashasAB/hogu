...
export default function NYCHome() {
  return (
    <div className="hogu-landing">
      ...
      <header className="hogu-shell hogu-header">
        ...
        <nav className="hogu-nav">
          ...
          <a className="hogu-link hogu-link--primary" href="/nyc/signup">
            Sign up
          </a>
        </nav>
      </header>
      ...
      <main className="hogu-shell hogu-hero">
        ...
        <p className="hogu-subtitle">
          ...
          Your personal wingman introduces you, sets you up, and gets you both out the door — right here in New York.
        </p>
        ...
        <section className="hogu-how-it-works">
          ...
          <div className="hogu-steps">
            ...
            <div className="hogu-step">
              ...
              <p>Your wingman finds a spot in your neighborhood and a time that works for both of you, and gets you both out the door. All you have to do is show up.</p>
            </div>
          </div>
        </section>
