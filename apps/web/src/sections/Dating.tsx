      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <a 
              href="http://localhost:5000/dating/signup"
              target="_blank"
            ...
            <a 
              href="http://localhost:5000/dating/login"
              target="_blank"
              rel="noopener noreferrer"
              className="border border-red-500 text-red-500 hover:bg-red-500 hover:text-white px-8 py-3 rounded-lg font-semibold transition-colors inline-block"
            >
              Sign In
            </a>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-500 text-sm">
              Note: The dating app runs on a separate port. Click the buttons above to access the full dating experience.
            </p>
          </div>
        </div>
      </div>
