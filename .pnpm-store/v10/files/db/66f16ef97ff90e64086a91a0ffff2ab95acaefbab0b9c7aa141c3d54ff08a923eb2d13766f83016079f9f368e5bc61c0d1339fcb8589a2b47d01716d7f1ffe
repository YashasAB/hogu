...
export declare class Watch extends APIResource {
     ...
     */
    sendEvents(body: WatchSendEventsParams, options?: Core.RequestOptions): Core.APIPromise<WatchSendEventsResponse>;
    /**
     ...
     */
    sendFeedbacks(body: WatchSendFeedbacksParams, options?: Core.RequestOptions): Core.APIPromise<WatchSendFeedbacksResponse>;
}
...
export declare namespace WatchPredictParams {
    /**
     * The prediction target. Only supports phone numbers for now.
     */
    interface Target {
...
export declare namespace WatchSendEventsParams {
    interface Event {
        /**
...
export declare namespace WatchSendFeedbacksParams {
    interface Feedback {
        /**
...
export declare namespace Watch {
    export { type WatchPredictResponse as WatchPredictResponse, type WatchSendEventsResponse as WatchSendEventsResponse, type WatchSendFeedbacksResponse as WatchSendFeedbacksResponse, type WatchPredictParams as WatchPredictParams, type WatchSendEventsParams as WatchSendEventsParams, type WatchSendFeedbacksParams as WatchSendFeedbacksParams, };
}
