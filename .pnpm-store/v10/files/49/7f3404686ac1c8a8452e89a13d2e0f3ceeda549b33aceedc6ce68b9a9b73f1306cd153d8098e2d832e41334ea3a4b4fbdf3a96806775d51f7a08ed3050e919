...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import '@prelude.so/sdk/shims/${shims.kind}'\` before importing anything else from @prelude.so/sdk`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import '@prelude.so/sdk/shims/${shims.kind}'\` after \`import '@prelude.so/sdk/shims/${exports.kind}'\``);
    }
